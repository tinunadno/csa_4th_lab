class ALU_signals:
    def __init__(self, reg1: int, reg2: int, shift = False, shift_left = False, cyclic = False, not_ = False, add = False, neg = False, add_c = False, comp = False, not_eq = False, fst_flag_bit = False, snd_flag_bit = False):
