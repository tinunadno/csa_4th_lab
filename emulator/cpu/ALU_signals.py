class ALU_signals:
    def __init__(self, reg1: int, reg2: int, shift = False, shift_left = False, cyclic = False, add = False, neg = False, comp = False, fst_flag_bit = False, second_flag_bit = False):
        ...
        :param second_flag_bit: second bit of comparison flag
        """
        self.reg1 = reg1
        self.reg2 = reg2
        self.shift = shift
        ...
        self.second_flag_bit = second_flag_bit
